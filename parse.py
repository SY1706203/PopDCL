...
def parse_args():
    ...
    parser.add_argument('--lr', type=float, default=1e-3,
                        help='Learning rate.')
    parser.add_argument('--regs', type=float, default=1e-4,
                        help='Regularization.')
    ...
    # BCL_LOSS
    parser.add_argument('--bcl_alpha', type=float, default=0.7,
                        help='hcl_alpha')
    parser.add_argument('--bcl_beta', type=float, default=0.5,
                        help='hcl_beta')
